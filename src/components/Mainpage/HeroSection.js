...
class HeroSection extends Component {
 ...
 render() {
      ...
      <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
        <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
          <div class="px-5 pt-4 flex items-center justify-between">
            <div>
              <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt=""></img>
            </div>
            <div class="-mr-2">
      ...
      <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          <h1 class="text-4xl tracking-tight font-extrabold text-grey-900 sm:text-5xl md:text-6xl">
            <span class="block xl:inline" id="happymind">Happy Mind leads to </span>
            <span class="block text-green-400 xl:inline" id="happylife">Happy Life!</span>
          </h1>
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          It’s normal to feel down, emotions like sadness and grief help make us human. Let's start this journey together and heal our lives.
          </p>
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src={xyz} alt=""></img>
  </div>
</div>
...
<div className="mainpage-card-div">
    ...
    <div className="card-content-div">
        <p className="card-head">Take Assessment with us to know how healthy you are!</p>
        <p className="card-content">This won’t give you a diagnosis but it will help you decide the next step.</p>
...
<div className="mainpage-card-div-1">
    ...
    <div className="card-content-div">
        <p className="card-head">Therapies & Games can change the way you think!</p>
...
<div className="bottom-img-div" style={{  
  backgroundImage: "url(" + "https://images.pexels.com/photos/34153/pexels-photo.jpg?auto=compress&cs=tinysrgb&h=350" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'
}}>
    <center><p className="quote-2">Come Join Us</p></center>
    <div className="btns">
   ...
   <div className="main-footer">
       ...
       <div className="footer-down">
            <p className="copyright"><center>Copyright © 2021 Soothe</center></p>
       </div>
